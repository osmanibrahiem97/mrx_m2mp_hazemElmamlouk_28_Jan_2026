...
import '../bloc/seller_order_detail_screen_bloc.dart';


Widget sellerOrderIdContainer(BuildContext context, SellerOrderDetailsMpModel? orderModel, AppLocalizations? localization,
    SellerOrderDetailMpBloc? _orderBloc, String? orderId) {
  return Container(
    ...
    Column(
      ...
      children: [
        ...
        Text(
          '${localization?.translate(MpStringConstants.orderId)} #${orderModel?.incrementId}',
        ...
        InkWell(
          onTap: () async {
              ...
              AppDialogHelper.confirmationDialog(
                ...
                _orderBloc?.add(OrderMailSentEvent(orderId!));
...
Widget sellerOrderPlaceDateContainer(BuildContext context, SellerOrderDetailsMpModel? orderModel, AppLocalizations? localization) {
  return Container(
      color: Theme.of(context).cardColor,
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.symmetric(
                ...
                vertical: AppSizes.spacingTiny),
/*            decoration: BoxDecoration(
                color: Utils.orderStatusBackground(orderModel!.state.toString(), "#66BB6A" *//*orderModel.statusColorCode.toString()*//*),
