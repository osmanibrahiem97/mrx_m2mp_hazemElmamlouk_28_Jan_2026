...
Widget SellerOrdersCreditMemoPriceDetails(SellerOrdersShipmentMpModel model, BuildContext context,
  ...
  return sellerOrderHeaderLayout(
      ...
      Padding(
        ...
        child: Column(
/*          children:
            (model.totals??[]).map((e) => SellerOrdersCreditMemoPriceDetailsItem(
                e.label ?? "",
                e.formattedValue??"",
                context)
...
Widget SellerOrdersCreditMemoPriceDetailsItem(String key, String value, BuildContext context) {
  return Padding(
