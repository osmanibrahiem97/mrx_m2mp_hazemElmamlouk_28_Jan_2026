...
import 'package:test_new/mobikul_mp/mp_screens/catalog_mp/bloc/catalog_screen_mp_event.dart';
...
import '../../../mobikul/screens/home/widgets/home_banners.dart';
import 'bloc/catalog_screen_mp_bloc.dart';
import 'bloc/catalog_screen_mp_state.dart';


class CatalogScreenMp extends StatefulWidget {
  const CatalogScreenMp(this.arguments, {Key? key}) : super(key: key);

  final Map<String, dynamic> arguments;

  @override
  State<CatalogScreenMp> createState() => _CatalogScreenMpState();
}

class _CatalogScreenMpState extends State<CatalogScreenMp> {
  late bool _isGrid, _loading, _sortApplied, _filterApplied;
  CatalogScreenMpBloc? _bloc;
  CatalogModel? _model;
  ...
  void initState() {
    ...
    _bloc = context.read<CatalogScreenMpBloc>();
    _callAPI();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appToolBar(
          ...
          context),
      body: SafeArea(
        child: BlocBuilder<CatalogScreenMpBloc, CatalogScreenMpState>(
