...
ProductDetailPageModel _$ProductDetailPageModelFromJson(
    ...
    ProductDetailPageModel(
      ...
      json['reportData'] == null
          ? null
          : ReportDataModel.fromJson(
              json['reportData'] as Map<String, dynamic>),
      json['isProductFlagsEnabled'] as bool?,
      json['productFlags'] == null
          ? null
          : ProductFlags.fromJson(json['productFlags'] as Map<String, dynamic>),
    )
...
Map<String, dynamic> _$ProductDetailPageModelToJson(
    ...
    <String, dynamic>{
      ...
      'isProductFlagsEnabled': instance.isProductFlagsEnabled,
      'productFlags': instance.productFlags,
    };
