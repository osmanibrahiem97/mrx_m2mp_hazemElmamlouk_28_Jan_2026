                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Visibility(
                              visible: (product?.soldBy != null && product?.soldBy != "") ?? false,
                              child: const SizedBox(height: AppSizes.size16)),
                          Visibility(
                            visible: (product?.soldBy != null && product?.soldBy != "") ?? false,
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: <Widget>[
                                Expanded(
                                    flex: 1,
                                    child: Text(
                                      "${localizations?.translate(AppStringConstant.soldBy) ?? ""}: ",
                                      style: Theme.of(context)
                                          .textTheme
                                          .titleMedium
                                          ?.copyWith(fontSize: 14),
