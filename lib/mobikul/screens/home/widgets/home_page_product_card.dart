...
class HomePageProductCard extends StatefulWidget {
  ...
  HomePageProductCard({super.key, this.product, this.imageSize,this.customerWishlist});
...
class _HomePageProductCardState extends State<HomePageProductCard> {
      ...
      builder: (context, currentState) {
        if (currentState is ItemCardInitial) {
          ...
          if (currentState.wishListModel.success == true) {
            print("wishListModel----${currentState.wishListModel.toJson()}");
            WidgetsBinding.instance?.addPostFrameCallback((_) {
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (await appStoragePref.isLoggedIn()) {
                        if ((widget.product?.isInWishlist != true) && !(isValueInList(widget.customerWishlist ?? [],  widget.product?.entityId ?? "0"))) {
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        (((widget.product?.isInWishlist ?? false) || (isValueInList(widget.customerWishlist ?? [],  widget.product?.entityId ?? "0"))))
                            ? Icons.favorite
                            : Icons.favorite_border_outlined,
                        color:  (((widget.product?.isInWishlist ?? false) || (isValueInList(widget.customerWishlist ?? [],  widget.product?.entityId ?? "0"))))
                            ? AppColors.lightRed
                            : AppColors.lightGray,
                        size: 18,
                      ),
  ...
  bool isValueInList(List<dynamic> list, dynamic value) {
