...
Widget ProductCarasoulType2(List<ProductTileData> products,
    ...
    {bool isShowViewAll = true, Function? callBack, List<dynamic>? customerWishlist, String? selectedColors, String? selectedImage}) {
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              color: selectedColors != null && selectedColors != ""
                  ? Color(int.parse(selectedColors.replaceAll('#', '0xFF')))
