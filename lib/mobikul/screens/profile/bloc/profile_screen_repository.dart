...
import 'dart:convert';
import '../../../../mobikul_mp/mp_network_manager/mp_api_client.dart';
...
abstract class ProfileScreenRepository{
  ...
  Future<SellerMenuData> sellerMenu();
...
class ProfileScreenRepositoryImp implements ProfileScreenRepository{
  ...
  @override
  Future<SellerMenuData> sellerMenu() async {
    SellerMenuData? responseData;
    try{
      responseData = await MPApiClient().sellerMenus();
    }
