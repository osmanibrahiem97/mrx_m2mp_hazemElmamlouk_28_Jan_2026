                ...
                Container(
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        return ConfigurableProductData(item.options?[index]?.label ?? "",item.options?[index]?.value?[0] ?? "",context);
...
Widget ConfigurableProductData(String key,String value,BuildContext context){
  return Padding(
    padding: const EdgeInsets.only(
        top: AppSizes.linePadding, left: AppSizes.linePadding),
    child: Row(
