...
class _CatalogScreenState extends State<CatalogScreen> {
  ...
  late List<Map<String, String>> _tempFilterData;
  ...
  @override
  void initState() {
    if (widget.arguments.containsKey(searchDataKey)) {
      print(
          "TEST_LOG: CatalogScreen received searchData: ${widget.arguments[searchDataKey]}");
    }
  ...
  _callAPI() {
    ...
    if(widget.arguments[searchDataKey] != null){
      _tempFilterData.clear();
      print("_selectedFilterData is empty: ${_selectedFilterData.isEmpty}");
      _tempFilterData.addAll(_selectedFilterData.isNotEmpty?_selectedFilterData:widget.arguments[searchDataKey]);
      //_tempFilterData.addAll(widget.arguments[searchDataKey]);
      print("callAPI with search data: ${_tempFilterData.toList().toString()}");
    ...
    _request = CatalogProductRequest(
        ...
        sortData: _sortData,
        filterData: (_tempFilterData.isNotEmpty) ? _tempFilterData : _selectedFilterData);
