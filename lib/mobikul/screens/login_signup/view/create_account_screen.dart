...
class _CreateAnAccountState extends State<CreateAnAccount> {
  ...
  void _focusErrorNode() {
    ...
    ///Shop Url for Mp
    else if (_shopUrlController.text.isEmpty) {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                ///Marketplace
                if (AppConstant.isMarketplace && (_signUpScreenModel?.sellerRegistrationStatus ?? false))
                  CheckboxListTile(
                    title: Text(
                      Utils.getStringValue(
                          context, AppStringConstant.checkboxTileHeading),
                    ),
                    controlAffinity: ListTileControlAffinity
                        .leading, // Fix checkbox on the left side
                    value: _isChecked,
                ...
                Visibility(
                  ...
                  child: TextFormField(
                    ...
                    decoration: formFieldDecoration(
                        ...
                        "",
                        Utils.getStringValue(
                            context, MpStringConstants.shopUrl),
                        isRequired: true),
                    validator: (value) {
                      if (value!.isEmpty) {
                        return Utils.getStringValue(
                ...
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      Utils.getStringValue(
                          context, AppStringConstant.textUnderShopUrlField),
                      style: Theme.of(context).textTheme.titleMedium?.copyWith(
                        fontWeight: FontWeight.w300,
                        fontSize: AppSizes.textSizeSmall,
                      ),
                ...
                SizedBox(height: _isChecked == true ? 20 : 5),
