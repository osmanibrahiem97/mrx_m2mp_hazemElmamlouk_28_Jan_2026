...
class _SplashScreenState extends State<SplashScreen> {
    ...
    return Stack(
      children: [
        SizedBox(
          ...
          child: (appStoragePref.getSplashScreen().isEmpty && appStoragePref.getSplashScreenDark().isEmpty) ? AppConstant.isMarketplace == true ? Image.asset(
            AppImages.splashScreen,
            fit: BoxFit.fill,
          ) : Image.asset(
            AppImages.mpbikulSplashScreen,
            fit: BoxFit.fill,
          ) :
          Container(
  ...
  void setLauncherIcon(){
    print("===========>>>>${homePageDataModel?.launcherIconType}");
    appStoragePref.setLauncherIconType(homePageDataModel?.launcherIconType ?? "");

    checkAppIconUpdate();

    print("--<===========${appStoragePref.getLauncherIconType()}");

  }


  void checkAppIconUpdate() async {
    print("Get Launch type=====>${appStoragePref.getLauncherIconType()}");
    const platform = MethodChannel(AppConstant.channelName);
    try {
      if (appStoragePref.getLauncherIconType() != appStoragePref.getLauncherIconUsed()) {
        appStoragePref.setLauncherIconUsed(
            appStoragePref.getLauncherIconType());
        if (Platform.isIOS) {
          await platform.invokeMethod(
              "dynamicLauncher", appStoragePref.getLauncherIconType());
        } else {
          print("Calle here====>");
          await platform.invokeMethod(
              "dynamicLauncher", appStoragePref.getLauncherIconType());
  ...
  Future<void> _updateLightTheme(String? lightAppBar,String? lightButton,String? lightButtonText,String? lightAppTextColor) async {
    ...
    print("LightAppBarColor: $lightAppBar \n, LightButton: $lightButton \n, LightButtonText: $lightButtonText \n, LightAppTextColor: $lightAppTextColor");
    ...
    AppTheme.lightTheme = AppTheme.lightTheme.copyWith(
      ...
      textTheme: TextTheme(
        ...
        // button: TextStyle(color: HexColor.fromHex(lightButtonText ?? ""),),
        // caption:TextStyle(
        //   fontSize: AppSizes.textSizeMedium,
        //   fontWeight: FontWeight.bold,
        //   fontFamily: "Roboto",
  ...
  Future<void> _updateDarkTheme(String? darkAppTheme,String? darkAppButton,String? darkAppButtonText,String? darkAppText) async{
    ...
    AppTheme.darkTheme  = AppTheme.darkTheme.copyWith(
      ...
      textTheme: TextTheme(
        ...
        //
        // button: TextStyle(color: HexColor.fromHex(darkAppButtonText ?? ""),),
        // caption: TextStyle(
        //   fontSize: AppSizes.textSizeMedium,
        //   fontWeight: FontWeight.bold,
        //   fontFamily: "Roboto",
