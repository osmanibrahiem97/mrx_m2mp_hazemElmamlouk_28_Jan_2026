...
import '../../../mobikul_mp/mp_screens/product_details_mp/product_seller_details.dart';
                    ...
                    SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (AppConstant.isMarketplace || _productDetailPageModel?.sellerInfo != null)
                              ProductSellerDetailsView(_productDetailPageModel?.sellerInfo,
                                  _productDetailPageModel?.productFlags,
                                  int.parse(widget.arguments[productIdKey] ?? "0",
                                      ),
                                  _productDetailPageModel?.isProductFlagsEnabled,
                                _productDetailPageModel?.productFlags?.otherFieldPlaceholder ?? ""
                              ),
                            ...
                            productInfo(
                                ...
                                context),
                            // widgetSpace(0,AppSizes.linePadding),
                            space(),
  ...
  Future startArActivity() async {
    if (Platform.isIOS) {
      GenericMethods.loadArOnIOS(
          context, _productDetailPageModel?.arUrl ?? "");
    }
