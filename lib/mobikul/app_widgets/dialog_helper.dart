...
class DialogHelper {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: (title != null)
          ...
          style: Theme.of(context).textTheme.headlineLarge?.copyWith(fontSize: AppSizes.textSizeMedium),
        )
            : null,
        content: Text(
  ...
  static deleteAccountConfirmationDialog(BuildContext context, String title,
    ...
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(title, style: Theme.of(context).textTheme.headlineLarge?.copyWith(fontSize: AppSizes.textSizeMedium),),
        content: Form(
          key: _formKey,
          child: Column(
            mainAxisSize: MainAxisSize.min,
