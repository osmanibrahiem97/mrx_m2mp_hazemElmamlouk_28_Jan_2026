  ...
  Widget build(BuildContext context) {
    ...
    for(int i = 0; i < (widget.labels?.length ?? 0); i++){
      ...
      Checkbox cb = Checkbox(
        ...
        onChanged: widget.isDisable ? null :  (bool? isChecked) => onChanged(isChecked ?? false, i),
        checkColor: widget.checkColor,
        activeColor: widget.activeColor ?? Theme.of(context).colorScheme.onPrimary,
