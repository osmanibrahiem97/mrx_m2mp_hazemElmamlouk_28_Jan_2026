...
void viewInvoiceBottomModelSheet(BuildContext context,String? invoiceId, String? orderId, String invoiceNo) {
  showAppModalBottomSheet(
      isScrollControlled: true,
      context: context,
      builder: (context) =>
          BlocProvider(
            ...
            child: ViewInvoiceScreen(orderId,invoiceId,"",invoiceNo),
          )
  );
}
