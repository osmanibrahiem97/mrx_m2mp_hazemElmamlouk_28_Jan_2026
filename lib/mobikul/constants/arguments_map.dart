...
Map<String, dynamic> getCatalogMap(
    String catalogId, String catalogName, String? type, bool fromNotification,
  ...
  args[searchDataKey] = searchData;
  return args;
}

Map<String, dynamic> getCheckoutMap(
    String shippingMethod, ShippingAddressModel? address,
...
Map<String, dynamic>? getNotificationArguments(
    String accountType, String senderId) {
  Map<String, dynamic> args = {};
