...
class ApiConstant {
  /// Market Place live domain Url
  ///    (.com domain)

  ///   (.in domain) Live Instance

  ///    Local Instance
  static const String webUrl = "https://mrxksa.com";

  static const String apiKey = 'mr.x';
  static const String apiPassword = 'R#^DwObaR(W%C2Di';
  ...
  static const String firebaseUrl =
      "https://mobikul-magento2-app.firebaseio.com"; //for mp app
}

class AppConstant {
  static const bool isMarketplace = true;

  /// Firebase Configuration ///
  static const fcmMessagingTopicAndroid = "mobikul_mrxsa_android";
  static const fcmMessagingTopiciOS = "mobikul_mrxsa_ios";

  /// Google Map Configuration ///
  static const String googleKey = "AIzaSyAmdrssRgNUm6SG4CP3B5gTmr30xRl8ajQ";
  ...
  static const bool advanceSearch = true;
...
class AppSizes {
  ...
  static const double spacingMax = 68;
  ...
  static const double dashBoardHeight = 230;
  ...
  static const double listHeightForSmallDevice = 126;
  ...
  static const double wishListGirdContentHeight = 129;

  /// Image Ration
  static const double imageHeightRation = 1;

  ///  WishList Grid Height
  static double claculatedWishListGridHeight =
      (calculatedGridWidth * AppSizes.imageHeightRation) +
          AppSizes.wishListGirdContentHeight;

  ///   Grid Height Regarding Device
  static double calculatedGridWidth =
      ((AppSizes.deviceWidth - AppSizes.spacingMedium) /
          AppSizes.gridProductCount);
  static double calculatedCatalogGridWidth =
      (AppSizes.deviceWidth) / AppSizes.gridProductCount;
  static double calculatedCatalogGridHeight =
      (calculatedCatalogGridWidth * AppSizes.imageHeightRation) +
          AppSizes.catalogGrideHeight;
  static double calculatedNormalDeviceGridHeight =
      (calculatedGridWidth * AppSizes.imageHeightRation) +
          AppSizes.gridHeightForSmallDevice;
  static double calculatedMediumDeviceGridHeight =
      (calculatedGridWidth * AppSizes.imageHeightRation) + AppSizes.gridHeight;
  static double calculatedNOrmalDeviceGridWidth =
      (AppSizes.deviceWidth - AppSizes.spacingMedium) /
          AppSizes.gridProductCount;

  /// List Height Regarding Device
  static double calculatedListHeight =
      ((calculatedGridWidth * AppSizes.imageHeightRation) +
          AppSizes.listHeightForSmallDevice);
}
...
class AppImages {
  ...
  static const splashScreen = "assets/images/splash_screen_mp.png";
  static const mpbikulSplashScreen = "assets/images/splash_screen.png";
