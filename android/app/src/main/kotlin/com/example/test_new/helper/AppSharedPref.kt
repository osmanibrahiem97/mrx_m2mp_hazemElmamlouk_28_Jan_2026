package com.example.test_new.helper
...
open class AppSharedPref {
    companion object {
        ...
        fun getCount(context: Context): Int {
            return getSharedPreference(context, CONFIGURATION_PREF).getInt(
                    KEY_LAUNCHER_COUNT,
                    0
            )
        }
        ...
        fun setCount(context: Context, count: Int) {
            getSharedPreferenceEditor(context, CONFIGURATION_PREF).putInt(
                    KEY_LAUNCHER_COUNT,
                    count
            ).apply()
        }
